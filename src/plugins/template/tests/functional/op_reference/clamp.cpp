...
std::vector<ClampParams> generateClampFloatParams() {
    ...
    std::vector<ClampParams> clampParams {
        ClampParams(ov::PartialShape {5, 2},
                    IN_ET,
                    std::vector<T>{-0.1f, 0.0f, 0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f, 0.7f, 0.8f},
                    std::vector<T>{0.2f, 0.2f, 0.2f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f, 0.6f, 0.6f},
                    0.2,
                    0.6),
        ClampParams(ov::PartialShape {5, 2},
                    IN_ET,
                    std::vector<T>{min, max, ninf, pinf, 9.99999f, 10.0f, 10.000001f, 19.999999f, 20.0f, 20.000001f},
                    std::vector<T>{10.0f, 20.0f, 10.0f, 20.0f, 10.0f, 10.0f, 10.000001f, 19.999999f, 20.0f, 20.0f},
                    10.0,
                    20.0),
        ClampParams(ov::PartialShape {5, 2},
                    IN_ET,
                    std::vector<T>{min, max, ninf, pinf, 9.99999f, 10.0f, 10.000001f, 19.999999f, 20.0f, 20.000001f},
                    std::vector<T>{10.0, max, 10.0f, pinf, 10.0f, 10.0f, 10.000001f, 19.999999f, 20.0f, 20.000001f},
                    10.0,
                    pinf),
        ClampParams(ov::PartialShape {5, 2},
                    IN_ET,
                    std::vector<T>{min, max, ninf, pinf, 9.99999f, 10.0f, 10.000001f, 19.999999f, 20.0f, 20.000001f},
                    std::vector<T>{min, 20.0f, ninf, 20.0f, 9.99999f, 10.0f, 10.000001f, 19.999999f, 20.0f, 20.0f},
                    ninf,
                    20.0)
    };
    return clampParams;
